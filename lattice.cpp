...
int hpx_main(boost::program_options::variables_map& vm) {
  ...
  if (algorithm.compare("simple") == 0) {
    ...
    lattice::grid2d_algorithms grid = lattice::grid2d_algorithms::from_file(
        grid_file_name, verbose);
  ...
  } else if (algorithm.compare("parvec") == 0) {
    lattice::grid2d_algorithms_parvec grid =
        lattice::grid2d_algorithms_parvec::from_file(grid_file_name, verbose);
...
int main(int argc, char* argv[]) {
  ...
  desc_commandline.add_options()("help", "display help")("grid-file",
      ...
      "steps", boost::program_options::value<size_t>()->default_value(1),
